...
public class OrderController {
	...
	public String order_reg(@RequestParam("menu_idx") String menu_idx, OrderBean orderBean, ClientBean clientBean,
			ProductBean productBean, Model model) {
	...
	public String client_list(ClientBean clientBean, @RequestParam("menu_idx") String menu_idx, Model model) {
	...
	public String order_approve(OrderBean orderBean, @RequestParam("menu_idx") String menu_idx, Model model) {
	...
	public String order_list(OrderBean orderBean, MenuBean menuBean, @RequestParam("menu_idx") String menu_idx,
