			...
			<div class="input-group mb-3">
				<table>
					...
					<tr>
						...
						<td><input type="text" id="client_name" name="client_name" class="form-control" value="${obj.client_name }"></td>
						<td><input type="text" id="client_tel" name="client_tel" class="form-control" value="${obj.client_tel }"></td>
						<td><input type="text" id="client_ceo" name="client_ceo" class="form-control" value="${obj.client_ceo }"></td>
						<td><input type="text" id="client_zipcode" name="client_zipcode" class="form-control" value="${obj.client_zipcode }"></td>
						<td><input type="text" id="client_addr" name="client_addr" class="form-control" value="${obj.client_addr }"></td>
					</tr>
					</c:forEach>
				</table>
			</div>
