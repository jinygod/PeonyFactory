...
<c:import url="/WEB-INF/views/include/top_menu.jsp"/>
	...
	<form:form action="${root }menu/input/order_pro" method="post" modelAttribute="orderInfoBean">
			...
			<div class="input-group mb-3">
				<table>
					<tr>
						...
						<td><input type="text" id="order_idx" name="order_idx" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">주문상태</span></th>
						<td><input type="text" id="order_status" name="order_status" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">출하상태</span></th>
						<td><input type="text" id="order_shipment" name="order_shipment" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" id="order_regdate" name="order_regdate" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">납기요청일</span></th>
						<td><input type="text" id="order_deadline" name="order_deadline" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">생산예상기간</span></th>
						<td><input type="text" id="order_exdate" name="order_exdate" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">수량</span></th>
						<td><input type="text" id="order_cnt" name="order_cnt" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">단위</span></th>
						<td><input type="text" id="order_unit" name="order_unit" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">단가</span></th>
						<td><input type="text" id="order_unit_price" name="order_unit_price" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">금액</span></th>
						<td><input type="text" id="order_amt" name="order_amt" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">담당자</span></th>
						<td><input type="text" id="order_manager" name="order_manager" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
					<tr>
						<th><span class="input-group-text" id="basic-addon1">등록일시</span></th>
						<td><input type="text" id="order_date" name="order_date" class="form-control" aria-label="Username" aria-describedby="basic-addon1"></td>
					</tr>
				</table>
			</div>
